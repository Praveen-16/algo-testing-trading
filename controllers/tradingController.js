...
const startTrading = async (req, res) => {
  try {
    // const { instrumentKeys, accessToken } = req.body;
    ...
    // if (!ltpResponse || !ltpResponse.data) {
    //   console.log("Failed to fetch LTPs", ltpResponse);
    //   return res.status(500).json({ error: "Failed to fetch LTPs" });
    // }
